        ...
                </mt-header>
                <div  style="position:relative;top:46px">
                    ...
                    <div style="position: relative;left:20px;top:10px;">
                        <span style="font-size:23px;position: relative;bottom: 10px;">{{list.title}}</span><br/>
            ...
            <div class="edit_container" v-show="!showContent" style="position: relative;top:60px;left:6px;">
              <quill-editor 
